        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering students worldwide to achieve their IELTS goals through innovative learning methods, 
              expert guidance, and comprehensive preparation tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#courses" className="text-gray-300 hover:text-white transition-colors duration-300">Courses</a>
              </li>
              <li>
                <a href="#practice" className="text-gray-300 hover:text-white transition-colors duration-300">Practice Tests</a>
              </li>
              <li>
                <a href="#testimonials" className="text-gray-300 hover:text-white transition-colors duration-300">Success Stories</a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-300">info@ieltspro.com</p>
                  <p className="text-gray-300">support@ieltspro.com</p>
                </div>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-blue-400 mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
